...
test("CTR is processed with TFN and Single Contribution-@CTR", async ({ memberPage, superSteam, globalPage, apiRequestContext }) => {
...
test("CTR is processed without TFN and Single Contribution-@CTR", async ({ memberPage, superSteam, globalPage, apiRequestContext }) => {
...
test("RTR is processed with TFN -@RTR", async ({ memberPage, superSteam, globalPage, apiRequestContext }) => {
    ...
    allure.logStep(`Expected Member payment Details From XML Is: ${expectedTaxAmount} ,${expectedNonTaxAmount},${expectedPreservedAmount},${expectedUnPreservedAmount},${expectedRestrictedAmount}`);
    ...
    allure.logStep(`Actual Member payment Details from UI Is: ${actualTaxAmount}, ${actualNonTaxAmount}, ${actualPreservedAmount},${actualUnPreservedAmount},${actualRestrictedAmount}`);
